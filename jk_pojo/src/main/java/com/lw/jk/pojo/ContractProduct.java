...
public class ContractProduct implements Serializable {
	...
	public String toString() {
		return "ContractProduct [contract=" + contract + ", factory=" + factory + ", extCproducts=" + extCproducts
				+ ", id=" + id + ", factoryName=" + factoryName + ", productNo=" + productNo + ", productImage="
				+ productImage + ", productDesc=" + productDesc + ", loadingRate=" + loadingRate + ", boxNum=" + boxNum
				+ ", packingUnit=" + packingUnit + ", cnumber=" + cnumber + ", outNumber=" + outNumber + ", finished="
				+ finished + ", productRequest=" + productRequest + ", price=" + price + ", amount=" + amount
				+ ", orderNo=" + orderNo + "]";
	}
