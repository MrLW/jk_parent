 ...
 * 报运单
 */
public class Export extends BasePojo implements Serializable{
	...
	public String toString() {
		return "Export [exportProducts=" + exportProducts + ", id=" + id + ", inputDate=" + inputDate + ", contractIds="
				+ contractIds + ", customerContract=" + customerContract + ", lcno=" + lcno + ", consignee=" + consignee
				+ ", marks=" + marks + ", shipmentPort=" + shipmentPort + ", destinationPort=" + destinationPort
				+ ", transportMode=" + transportMode + ", priceCondition=" + priceCondition + ", remark=" + remark
				+ ", boxNums=" + boxNums + ", grossWeights=" + grossWeights + ", measurements=" + measurements
				+ ", state=" + state + "]";
	}	
