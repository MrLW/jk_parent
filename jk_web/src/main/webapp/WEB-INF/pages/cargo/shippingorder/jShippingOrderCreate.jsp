			...
			<div id="middleMenubar">
				<div id="innerMenubar">
					<div id="navMenubar">
						<ul>
							<li id="save"><a href="#"
								onclick="formSubmit('shippingOrderAction_insert','_self');this.blur();">保存</a></li>
		...
		<div>
			<table class="commonTable" cellspacing="1">
				...
				<tr>
					...
					<td class="tableContent"><input type="text" name="shipper"
						value="" /></td>
				...
				<tr>
					...
					<td class="tableContent"><input type="text" name="notifyParty"
						value="" /></td>
				...
				<tr>
					...
					<td class="tableContent"><input type="text"
						name="portOfLoading" value="" /></td>
					<td class="columnTitle">转船港：</td>
					<td class="tableContent"><input type="text" name="portOfTrans"
						value="" /></td>
				</tr>
				<tr>
					<td class="columnTitle">卸货港：</td>
					<td class="tableContent"><input type="text"
						name="portOfDischarge" value="" /></td>
				</tr>
				<tr>
					<td class="columnTitle">装期：</td>
					<td class="tableContent"><input type="text"
						style="width: 90px;" name="loadingDate" value=""
						onclick="WdatePicker({el:this,isShowOthers:true,dateFmt:'yyyy-MM-dd'});" />
					</td>

					<td class="columnTitle">效期：</td>
					<td class="tableContent"><input type="text"
						style="width: 90px;" name="limitDate" value=""
						onclick="WdatePicker({el:this,isShowOthers:true,dateFmt:'yyyy-MM-dd'});" />
					</td>
				</tr>
				<tr>
					...
					<td class="tableContent">
						<!-- <input type="text" name="isBatch" value=""/> --> <select
						name="isBatch">
							<option value="1">分批</option>
				...
				<tr>
					...
					<td class="tableContent"><!-- <input type="text" name="isTrans"
						value="" /> -->
							<select name="isTrans">
				...
				<tr>
					...
					<td class="tableContent"><input type="text"
						name="specialCondition" value="" /></td>
				</tr>
				<tr>
					<td class="columnTitle">运费说明：</td>
					<td class="tableContent"><input type="text" name="freight"
						value="" /></td>
				...
				<tbody class="tableBody">
					...
					<c:forEach items="${ packingList }" var="o" varStatus="status">
						<tr align="left" class="odd"
							...
							<!-- 委托管理的id和装箱的id是一对一关系,因此这两个id保持一致,并且这是个单选 -->
							<td><input type="radio" name="packingListId" value="${o.id}" />
							</td>
