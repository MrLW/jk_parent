			...
			<div id="middleMenubar">
				<div id="innerMenubar">
					<div id="navMenubar">
						<ul>
							<li id="save"><a href="#"
								onclick="formSubmit('contractProductAction_insert','_self');this.blur();">保存</a></li>
			...
			<table class="commonTable" cellspacing="1">
				...
				<tr>
					...
					<td class="tableContentAuto"><input type="radio"
						name="packingUnit" value="PCS" class="input">只 <input
						type="radio" name="packingUnit" value="SETS" class="input">套
					</td>
				</tr>
				<tr>
					<td class="columnTitle">装率：</td>
					<td class="tableContent"><input type="text" name="loadingRate"
						value="" /></td>
				...
				<tbody class="tableBody">
					...
					<c:forEach items="${results}" var="o" varStatus="status">
						<tr class="odd" onmouseover="this.className='highlight'"
							...
							<td>${o.amount}</td>
							<td><a
								href="contractProductAction_toupdate.action?id=${o.id}">[修改]</a>
								<a
								href="contractProductAction_delete.action?id=${o.id}&contract.id=${o.contract.id}">[删除]</a>
								<a
								href="extCproductAction_tocreate.action?contractProduct.contract.id=${o.contract.id}&contractProduct.id=${o.id}">[附件]</a>
							</td>
						</tr>
						<!--  遍历货物下的附件 -->
